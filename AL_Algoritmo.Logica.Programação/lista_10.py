...
def soma_na_lista(n, lista):
  ...
  li = len(lista)
  while i < li:
    for nu in range(i+1,li):
      if lista[i] + lista[nu] == n and lista[i] != lista[nu]:
        soma_na_lista = True
        break
    i +=1
  return soma_na_lista
...
def test(obtido, esperado):
  if obtido == esperado:
    ...
    prefixo = '\033[31m Ainda não\033[m'
